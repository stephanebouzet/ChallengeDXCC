...
static constexpr auto qt_meta_stringdata_ZN15JtdxUdpListenerE = QtMocHelpers::stringData(
    "JtdxUdpListener",
    "adifReceived",
    "",
    "adifText",
...
Q_CONSTINIT static const uint qt_meta_data_ZN15JtdxUdpListenerE[] = {
...
Q_CONSTINIT const QMetaObject JtdxUdpListener::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN15JtdxUdpListenerE.offsetsAndSizes,
    qt_meta_data_ZN15JtdxUdpListenerE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN15JtdxUdpListenerE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<JtdxUdpListener, std::true_type>,
        // method 'adifReceived'
...
void JtdxUdpListener::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (JtdxUdpListener::*)(const QString & , const QString & , const QString & );
            if (_q_method_type _q_method = &JtdxUdpListener::adifReceived; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _q_method_type = void (JtdxUdpListener::*)(const QString & );
            if (_q_method_type _q_method = &JtdxUdpListener::logLine; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            using _q_method_type = void (JtdxUdpListener::*)(bool , const QString & );
            if (_q_method_type _q_method = &JtdxUdpListener::stateChanged; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
...
void *JtdxUdpListener::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN15JtdxUdpListenerE.stringdata0))
