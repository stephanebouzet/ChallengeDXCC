...
static constexpr auto qt_meta_stringdata_ZN21PSKReporterMQTTClientE = QtMocHelpers::stringData(
...
Q_CONSTINIT static const uint qt_meta_data_ZN21PSKReporterMQTTClientE[] = {
...
Q_CONSTINIT const QMetaObject PSKReporterMQTTClient::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN21PSKReporterMQTTClientE.offsetsAndSizes,
    qt_meta_data_ZN21PSKReporterMQTTClientE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN21PSKReporterMQTTClientE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<PSKReporterMQTTClient, std::true_type>,
        // method 'spotReceived'
...
void PSKReporterMQTTClient::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (PSKReporterMQTTClient::*)(const QJsonObject & );
            if (_q_method_type _q_method = &PSKReporterMQTTClient::spotReceived; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _q_method_type = void (PSKReporterMQTTClient::*)(const QString & );
            if (_q_method_type _q_method = &PSKReporterMQTTClient::logLine; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            using _q_method_type = void (PSKReporterMQTTClient::*)(bool , const QString & );
            if (_q_method_type _q_method = &PSKReporterMQTTClient::stateChanged; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
...
void *PSKReporterMQTTClient::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN21PSKReporterMQTTClientE.stringdata0))
